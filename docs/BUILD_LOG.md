...
3. Wrote [`SPEC.md`](process/SPEC.md) to define audience, scope, constraints, acceptance criteria, and verification commands.
4. Wrote [`PLAN.md`](process/PLAN.md) to break the work into four vertical slices.
5. Wrote [`TODO.md`](process/TODO.md) to track slice status and freeze scope for the next implementation step.
