...
| --- | --- | --- | --- |
| 1 | `$mini-spec` | Define repo goal, audience, constraints, and v0.1 scope | [`SPEC.md`](../SPEC.md) |
| 2 | `$thin-plan` | Break the build into small vertical slices | [`PLAN.md`](../PLAN.md), [`TODO.md`](../TODO.md) |
| 3 | `$scope-freeze` | Freeze write scope before each slice | Scope sections in [`TODO.md`](../TODO.md) and [`docs/BUILD_LOG.md`](./BUILD_LOG.md) |
